...
$nama = "Hasna Aulya Mustika Dewi";  // Nama lengkap
$umur = "17";  // Umur dalam bentuk integer
$sekolah = "SMKN 2 Bandung";  // Nama sekolah
$foto = "barbie.jpg"; // Path atau nama file gambar profil (Pastikan file ini ada di direktori yang sama)
...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: pink; /* Warna latar belakang baby blue */
        ...
        .profil-container h2 {
            ...
            color: plum; /* Warna teks untuk judul */
            font-size: 24px; /* Ukuran font untuk judul */
            border-bottom: 2px solid pink; /* Garis bawah biru pada judul */
        ...
        .profil-container p strong {
            color: plum; /* Warna teks tebal untuk label */
        }
        ...
        .styled-button {
    background-color: magenta; /* Warna latar belakang biru */
